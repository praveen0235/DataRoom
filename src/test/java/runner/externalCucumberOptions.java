...
public class externalCucumberOptions {
	...
	public static String createAndGetCucumberOption(){       
	     ...
	     String featureFilesPath = PropertyFileReader.properties.getProperty("cucumber.options.feature");
	...
	public static void main(String[] args) throws IOException, ParseException {
			...
			System.out.println("Execution process Started....");
			 FileUtils.copyFile(new File(System.getProperty("user.dir")+"/Uploadfiles/DummyReport/ExcelReport.xlsx"), Paths.get(System.getProperty("user.dir")+"/test-output/ExcelReport/ExcelReport.xlsx").toFile());
